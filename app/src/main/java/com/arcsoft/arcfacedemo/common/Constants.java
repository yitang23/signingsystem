...
public class Constants {
    ...
    public static final String APP_ID = "FqKXUQ9tqrYH1tSeN7r5xFrVyXZL1Wn4VkL1Q2gyJzzs";
    public static final String SDK_KEY = "9VmdJEDDvgt9S7HiZeUy4scmLQF1q8stgAbHXzNnoAGN";
