...
public class DBUtils {
    ...
    public static List<Qdrecord> Select_QdrecordByCid(String cid) {
        ...
        try {
            ...
            String sql= "SELECT qid,student.sname,student.sno,qdrecord.cid," +
                    "qdrecord.qtime,qdrecord.qteachermsg,qdrecord.lng,qdrecord.lat " +
    ...
    //签到成功
    public static boolean Update_QD_info(String sno,String qtime,String cid){
        boolean b=false;
        Connection conn = getConn();
        if (conn != null){
            Log.d("数据库连接状况", "Login: 成功");
