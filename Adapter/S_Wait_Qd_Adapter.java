...
public class S_Wait_Qd_Adapter extends BaseAdapter {
    ...
    private Map map;
    public S_Wait_Qd_Adapter(List<Finish_qd> mData, Context mContext, Map map){
        this.mData=mData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView cname=(TextView)convertView.findViewById(R.id.cname_14);
        TextView qtime=(TextView)convertView.findViewById(R.id.start_time2);
        TextView longtime=(TextView)convertView.findViewById(R.id.longtime_2);
        TextView count_qd=(TextView)convertView.findViewById(R.id.count_qd_2);
